      ...
      <div className="mb-6">
        {!showForm ? (
          <button
            ...
            className="bg- text-white font-semibold px-6 py-3 rounded-xl shadow-md transition duration-300"
          >
          ...
          >
            <h2 className="text-xl font-bold text-gray-800">New Recurring Expense</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                placeholder="Title"
                required
                className="border p-3 rounded-lg w-full focus:ring-2 focus:ring-yellow-500 focus:outline-none"
              />
              <input
                type="number"
                name="amount"
            ...
            <div className="flex gap-4 mt-4">
              <button
                type="submit"
                className="flex-1 bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-3 rounded-xl shadow-md transition duration-300"
              >
                Add
              </button>
              <button
            ...
            >
              <div>
                ...
                <p className="text-gray-500 mb-2">
                  Frequency: <span className="capitalize">{r.frequency}</span>
                </p>
                <span
